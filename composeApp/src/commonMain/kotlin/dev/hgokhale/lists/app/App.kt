...
fun App(
    ...
    scaffoldViewModel: ScaffoldViewModel = viewModel { ScaffoldViewModel() },
    navigationViewModel: NavigationViewModel = viewModel { NavigationViewModel() },
) {
    val snackbarHostState = remember { SnackbarHostState() }

    LaunchedEffect(Unit) {
        scaffoldViewModel.snackbarEvents.collect { event ->
            launch {
        ...
        Column( // We add this colum to center the app content on a large screen e.g. desktop or web
            ...
            CompositionLocalProvider(LocalTextStyle provides primaryTextStyle) {
                Scaffold(
                    ...
                    topBar = { TopBar(scaffoldViewModel, navigationViewModel) },
                    ...
                    NavGraph(paddingValues, navController, scaffoldViewModel, navigationViewModel)
                }
            }
        }
    }
